 ...
 * @author Gurrea
 */
public class AttentionsControllerTest extends APITest {//Provem les crides de Attentions
     @Test
    public void listActivities_withFilter() {//Fem una prova amb un filtre per a la cerca de Attentions
